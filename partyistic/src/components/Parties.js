...
export default function Parties() {
  ...
  return (
    <>
      ...
      <Button variant="outline-secondary" onClick={handleShow}>Share Your Party</Button>
        ...
        <Modal.Body>
          <Form onSubmit>
            ...
            <Form.Group className="mb-3" controlId="privacy">
              Privacy:   
            <Form.Check type="radio" inline label="Public"/>
            <Form.Check type="radio"  inline label="Private" />
            </Form.Group>
